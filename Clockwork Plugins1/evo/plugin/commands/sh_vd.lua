...
local COMMAND = Clockwork.command:New("VD");
...
function COMMAND:OnRun(player, arguments)
	if (Schema:PlayerIsCombine(player)) then
		if (Schema:IsPlayerCombineRank( player, {"SCN", "SeC", "CmD", "DvL"} ) or player:GetFaction() == FACTION_OTA or player:GetFaction() == FACTION_ADMIN) then
