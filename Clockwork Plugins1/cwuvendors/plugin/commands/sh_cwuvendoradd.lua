...
local COMMAND = Clockwork.command:New("CwuVendorAdd");
COMMAND.tip = "Add a CWU vending machine at your target position.";
...
function COMMAND:OnRun(player, arguments)
	...
	local entity = scripted_ents.Get("cwu_vend"):SpawnFunction(player, trace)
