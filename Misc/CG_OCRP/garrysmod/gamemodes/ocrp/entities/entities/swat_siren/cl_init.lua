...
local Lights = {}
Lights.Positions = {
{Vector(-35, 120, 42), Angle(0, 0, 0), Color(255,255,255,255), false};
{Vector(35, 120, 42), Angle(0, 0, 0), Color(255,255,255,255), false};
{Vector(-38, -130, 46), Angle(180, -180, 0), Color(255,0,0,255), false};
{Vector(38, -130, 46), Angle(180, -180, 0), Color(255,0,0,255), true};
{Vector(-38, -130, 95), Angle(180, -180, 0), Color(255,0,0,255), true};
{Vector(38, -130, 95), Angle(180, -180, 0), Color(255,0,0,255), false};

{Vector(0, 70, 108), Angle(0, 0, 0), Color(0,0,255,255), true};
{Vector(6, 70, 108), Angle(0, 0, 0), Color(0,0,255,255), true};
{Vector(12, 70, 108), Angle(0, 0, 0), Color(0,0,255,255), true};
{Vector(18, 70, 108), Angle(0, 0, 0), Color(0,0,255,255), true};
{Vector(24, 70, 108), Angle(0, 0, 0), Color(0,0,255,255), true};
{Vector(30, 70, 108), Angle(0, 0, 0), Color(0,0,255,255), true};
{Vector(-6, 70, 108), Angle(0, 0, 0), Color(0,0,255,255), true};
{Vector(-12, 70, 108), Angle(0, 0, 0), Color(0,0,255,255), true};
{Vector(-18, 70, 108), Angle(0, 0, 0), Color(0,0,255,255), true};
{Vector(-24, 70, 108), Angle(0, 0, 0), Color(0,0,255,255), true};
...
function ENT:DrawTranslucent()
	...
	if GetConVarNumber("ocrp_advlights") == 1 then --Only displays the sprites if the driver is present (reduces lag)
		for k, v in pairs(Lights.Positions) do	
			local truePos = self.Parent:LocalToWorld(Vector(v[1].x+7, v[1].y, v[1].z))
		...
		if dlight && curLight==1 then
			dlight.Pos = self.Parent:LocalToWorld(Vector(7,240,20))
			dlight.r = 255
			dlight.g = 255
			dlight.b = 255
			dlight.Brightness = 6
		...
		elseif dlight && curLight==2 then
			dlight.Pos = self.Parent:LocalToWorld(Vector(7,110,130))
			dlight.r = 0
			dlight.g = 0
			dlight.b = 255
			dlight.Brightness = 8
