...
local Lights = {}
Lights.Positions = {
{Vector(-25, 100, 32), Angle(0, 0, 0), Color(255,255,255,255), false};
{Vector(25, 100, 32), Angle(0, 0, 0), Color(255,255,255,255), true};
{Vector(-30, -120, 34), Angle(180, -180, 0), Color(255,0,0,255), false};
{Vector(30, -120, 34), Angle(180, -180, 0), Color(255,0,0,255), true};

{Vector(19, -13, 72), Angle(0, 0, 0), Color(255,0,0,255), true};
{Vector(19, -13, 72), Angle(180, -180, 0), Color(255,0,0,255), true};
{Vector(13, -9, 72), Angle(0, 0, 0), Color(0,0,255,255), false};
...
{Vector(0, 0, 72), Angle(0, 0, 0), Color(0,0,255,255), true};
{Vector(0, 0, 72), Angle(180, -180, 0), Color(0,0,255,255), true};
