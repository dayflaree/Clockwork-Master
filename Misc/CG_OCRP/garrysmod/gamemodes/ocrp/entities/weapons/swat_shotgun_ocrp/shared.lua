...
SWEP.IronSightsPos = Vector (5.1834, -2.2768, 2.1519)
SWEP.IronSightsAng = Vector (0.0147, 0.7292, -0.6098)
...
function SWEP:CSShootBullet(dmg, recoil, numbul, cone)
	...
	bullet.Force 	= 0.8 * dmg     								-- Amount of force to give to phys objects
