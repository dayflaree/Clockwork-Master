...
AddGear("Force Hands", "Force a player to use their hands.", false,
	function ( Player, Trace )
			if IsValid(Trace.Entity) and Trace.Entity:IsPlayer() then
				...
				Trace.Entity:Hint("Put your fucking keys/physgun/pistol or whatever away. If I see it again, you WILL be removed.")
			end
	end
);
...
AddGear("Info", "Prints info about the player you're targeting.", false,
	function ( Player, Trace )
			if IsValid(Trace.Entity) and Trace.Entity:IsPlayer() then
				...
				else Player:PrintMessage(HUD_PRINTCONSOLE,"Rank: Regular")
				end
