...
function OCRP_Challenge_Add_Ingame( ply, name, desc, reward, pro, item, event )
	...
	tmysql.query( "INSERT INTO `ocrp_challenges` (`Name`, `Desc`, `Reward`, `Pro`, `Item`, `Event`) VALUES('".. name .."', '".. desc .."', '".. reward .."', '".. pro .."', '".. item .."', '".. event .."')" )
...
function OCRP_Challenges_Load()
	tmysql.query( "SELECT * FROM `ocrp_challenges`",
	function( results )
...
function LetsTest33(ply, cmd, args)

end
concommand.Add("LetsTest33", LetsTest33)
...
function PrintProgress(ply,cmd,args)
	print(ply.OCRPData["Challenges"]["2_Pots"].Num)
end
concommand.Add("PrintProgress", PrintProgress)
