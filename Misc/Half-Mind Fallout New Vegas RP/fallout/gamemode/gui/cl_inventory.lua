...
function PANEL:Paint( w, h )
	...
	surface.SetDrawColor( Color( 252, 178, 69, 40 ) );
...
function PANEL:Paint( w, h )
	...
	if( self.Item.Vars.Caps ) then
	
		surface.SetTextColor( Color( 255, 255, 255, 255 ) );
		surface.SetFont( "Infected.LabelSmaller" );
		surface.SetTextPos( 4, 4 );
		surface.DrawText( self.Item.Vars.Caps );
		
	end
	
	if( self.Item.Vars.Uses ) then
	
		surface.SetTextColor( Color( 255, 255, 255, 255 ) );
		surface.SetFont( "Infected.LabelSmaller" );
		surface.SetTextPos( 4, 4 );
		surface.DrawText( self.Item.Vars.Uses );
