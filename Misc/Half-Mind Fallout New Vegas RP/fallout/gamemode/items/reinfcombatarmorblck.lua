ITEM.Name = "Black Reinforced Combat Armor";
ITEM.Desc = "A reinforced set of combat armor used by infantry in the Great War, quite rare. This set is a matte black.";
