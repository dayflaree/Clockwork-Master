...
SWEP.UseHands		= true;
SWEP.ViewModel 		= "models/weapons/view/c_lazarus_m_knife.mdl";
SWEP.WorldModel 	= "models/weapons/w_lazarus_m_knife.mdl";
...
SWEP.Description = "A knife meant for self-defense or utility. Not quite as common as kitchen knives, but worth their weight in gold in the Wastes.";
SWEP.W = 1;
SWEP.H = 2;
