...
function Layers.GravGunPickup( ply, ent )
	if ( ply:GetLayer() != ent:GetLayer() ) then return false end
end
hook.Add( "GravGunOnPickedUp", "LayersGravGunPickup", Layers.GravGunPickup )
