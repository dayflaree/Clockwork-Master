...
function PANEL:Init()
	if (!Clockwork.theme:Call("PreCharacterMenuInit", self)) then
		...
		self.titleLabel:SetText(string.upper(
			Schema:GetName()
		));
		...
		self.subLabel:SetText(string.upper(
		...
		self.authorLabel:SetText(string.upper(
			Clockwork.language:GetPhrase("developed_by", Schema:GetAuthor())
		));
		...
		self.createButton:SetText(string.upper(
			Clockwork.language:GetPhrase("new")
		));
		...
		self.loadButton:SetText(string.upper(
			Clockwork.language:GetPhrase("load")
		));
		...
		self.disconnectButton:SetText(string.upper(
			Clockwork.language:GetPhrase("leave")
		));
		...
		self.previousButton:SetText(string.upper(
			Clockwork.language:GetPhrase("previous")
		));
		...
		self.nextButton:SetText(string.upper(
			Clockwork.language:GetPhrase("next")
		));
		...
		self.cancelButton:SetText(string.upper(
			Clockwork.language:GetPhrase("cancel")
		));
	...
	if (!Clockwork.theme:Call("PreCharacterMenuPaint", self)) then
		...
		if (schemaLogo != "" and subLabelAlpha > 0) then
			if (!self.logoTextureID) then
				self.logoTextureID = Clockwork.kernel:GetMaterial(schemaLogo..".png");
			end;
