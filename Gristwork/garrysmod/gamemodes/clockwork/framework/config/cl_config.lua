...
Clockwork.config:AddToSystem("Use own admin system", "use_own_group_system", "Whether or not you use a different group or admin system to Clockwork.");
...
Clockwork.config:AddToSystem("Use free aiming", "use_free_aiming", "Whether or not free aiming is enabled.");
...
Clockwork.config:AddToSystem("Enable chat multiplier", "enable_chat_multiplier", "Whether or not to use the chat text size multiplier system.");