...
function createItemViewer()
	...
	itemviewer.modelpath.OnEnter = function( self )
		...
		itemviewer.model:SetCamPos( Vector( 0, -200, 0 ) )
	 	itemviewer.model:SetLookAt( Vector( 0, 0, 0 ) )
	...
	for j = 1, 3 do
		...
		itemviewer.ObjectPos[j]:SetValue( 0 );
		
		if( j == 2 ) then
			itemviewer.ObjectPos[j]:SetValue( -200 );
		end
...
function createAnimationViewer()
	...
	local animviewermodels =
	{
		...
		"models/characters/Umage/umage.mdl",
		"models/characters/UAssassin/uassassin.mdl",
		"models/hecu01/1.mdl",
		"models/hecu01/2.mdl",
		"models/hecu01/3.mdl",
		"models/hecu01/4.mdl",
...
function UpdateDoor( msg )
	...
	door:GetTable().DoorName = name;
	door:GetTable().DoorPrice = price;
	door:GetTable().DoorFlags = flags;
	door:GetTable().DoorFamily = family;
	door:GetTable().StorageWidth = w;
	door:GetTable().StorageHeight = h;
