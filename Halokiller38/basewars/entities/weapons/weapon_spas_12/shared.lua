...
---------------------------------------------------------*/
SWEP.MuzzleEffect			= "effect_mad_shotgunsmoke" -- This is an extra muzzleflash effect
...
SWEP.Primary.Sound 		= Sound("weapons/Hk_M3/spas12-1.wav")
...
SWEP.data.semi.Cone 		= 0.007	-- Cone of the slug rounds
