...
CfgVars["famascost"] = 700
CfgVars["scoutcost"] = 850
CfgVars["paracost"] = 5000
CfgVars["sg550cost"] = 3500
CfgVars["sg552cost"] = 3000
CfgVars["Smokecost"] = 1000
CfgVars["P90cost"] = 2000
...
CfgVars["maxvuvu"] = 100
CfgVars["maxlamp"] = 3
CfgVars["stickycost"] = 2000
CfgVars["doorcharge"] = 500
CfgVars["C4cost"] = 10000
CfgVars["pipebombcost"] = 500
CfgVars["crossbowcost"] = 3000
...
buytable["Weapons - HandGuns"].Names = {"P228","Deagle","Glock","FiveSeven","USP","Elites"}
buytable["Weapons - HandGuns"].Cost = {CfgVars["p228cost"],CfgVars["deaglecost"],CfgVars["glockcost"],CfgVars["fivesevencost"],CfgVars["uspcost"],CfgVars["elitescost"]}
buytable["Weapons - HandGuns"].Data = {"p228","deagle","glock","fiveseven","usp","elites"}
buytable["Weapons - HandGuns"].Cmd = "buypistol"
buytable["Weapons - HandGuns"].Model = {"models/weapons/w_pist_p228.mdl", "models/weapons/w_pist_deagle.mdl", "models/weapons/w_pist_glock18.mdl", "models/weapons/w_pist_fiveseven.mdl", "models/weapons/w_pist_usp.mdl", "models/weapons/w_pist_elite_dropped.mdl"}

buytable["Weapons - General"] = {}
buytable["Weapons - General"].Names = {"Mac-10","TMP","UMP45","P90","M4A1","Para","Shotgun","MP5","Galil","AUG","AK-47","Flamethrower","Sniper","Auto-Shotgun","Auto-Sniper","SG550","SG552","Crossbow","Scout","Famas"}
buytable["Weapons - General"].Cost = {CfgVars["mac10cost"],CfgVars["tmpcost"],CfgVars["umpcost"],CfgVars["p90cost"],CfgVars["m16cost"],CfgVars["paracost"],CfgVars["shotguncost"],CfgVars["mp5cost"],CfgVars["galilcost"],CfgVars["augcost"],CfgVars["ak47cost"],CfgVars["flamethrowercost"],CfgVars["snipercost"],CfgVars["autoshotguncost"],CfgVars["autosnipecost"],CfgVars["sg550cost"],CfgVars["sg552cost"],CfgVars["crossbowcost"],CfgVars["scoutcost"],CfgVars["famascost"],CfgVars["miniguncost"],CfgVars["spascost"]}
buytable["Weapons - General"].Data = {"mac10","tmp","ump","p90","m4","para","shotgun","mp5","galil","aug","ak47","flamethrower","sniper","autoshotgun","g3","sg550","sg552","crossbow","scout","famas"}
buytable["Weapons - General"].Cmd = "buyshipment"
buytable["Weapons - General"].CmdTwo = "buyweapon"
buytable["Weapons - General"].Model = {"models/weapons/w_smg_mac10.mdl", "models/weapons/w_smg_tmp.mdl", "models/weapons/w_smg_ump45.mdl", "models/weapons/w_smg_p90.mdl", "models/weapons/w_rif_m4a1.mdl", "models/weapons/w_mach_m249para.mdl", "models/weapons/w_shot_m3super90.mdl", "models/weapons/w_smg_mp5.mdl", "models/weapons/w_rif_galil.mdl", "models/weapons/w_rif_aug.mdl", "models/weapons/w_rif_ak47.mdl", "models/Weapons/w_smg1.mdl", "models/weapons/w_snip_awp.mdl", "models/weapons/w_shot_xm1014.mdl", "models/weapons/w_snip_g3sg1.mdl", "models/weapons/w_snip_sg550.mdl", "models/weapons/w_rif_sg552.mdl", "models/weapons/w_crossbow.mdl", "models/weapons/w_snip_scout.mdl", "models/weapons/w_rif_famas.mdl", "models/weapons/w_models/w_minigun.mdl", "models/weapons/v_spas12_shotgun.mdl"}

buytable["Weapons - Grenades"] = {}
buytable["Weapons - Grenades"].Names = {"Grenade","Stun Grenade","Gas Grenade","Pipe Bomb","Sticky Grenades","smoke Grenade","Door Charges","C4 Explosive"}
buytable["Weapons - Grenades"].Cost = {CfgVars["grenadecost"],CfgVars["flashbangcost"],CfgVars["gasgrenadecost"],CfgVars["pipebombcost"],CfgVars["stickycost"],CfgVars["Smokecost"],CfgVars["doorcharge"],CfgVars["C4cost"]}
buytable["Weapons - Grenades"].Data = {"grenade","stun","gas","pipebomb","sticky","smoke","doorcharge","c4"}
buytable["Weapons - Grenades"].Cmd = "buyweapon"
buytable["Weapons - Grenades"].Model = {"models/weapons/w_eq_fraggrenade_thrown.mdl", "models/weapons/w_eq_smokegrenade_thrown.mdl", "models/weapons/w_eq_smokegrenade.mdl", "models/props_lab/pipesystem03b.mdl", "models/magnusson_device.mdl", "models/weapons/w_eq_smokegrenade_thrown.mdl", "models/weapons/w_slam.mdl", "models/weapons/w_c4_planted.mdl"}
...
--buytable["Structures - General"].Cost = {CfgVars["turretcost"],150,400,500,500,1000,1000,400,2500,500,1000}
...
buytable["Structures - Base"].Names = {"Sentry Gun","Spawn Point","Dispenser","Radar Tower","Drug Refinery","Gun Factory","Gun Lab","Generator","Super Generator","Money Vault","Supply Table"}
buytable["Structures - Base"].Cost = {CfgVars["turretcost"],150,400,500,500,1000,1000,400,2500,500,1000,500}
buytable["Structures - Base"].Data = {"sentry","spawn","dispenser","radar","refinery","factory","gunlab","generator","supergenerator","moneyvault","supplycabinet"}
buytable["Structures - Base"].Cmd = "buystruct"
buytable["Structures - Base"].Model = {"models/props_c17/TrapPropeller_Engine.mdl", "models/props_trainstation/trainstation_clock001.mdl", "models/props_lab/reciever_cart.mdl", "models/props_rooftop/roof_dish001.mdl", "models/props_c17/furniturestove001a.mdl", "models/props/de_prodigy/transformer.mdl", "models/props_c17/FurnitureBoiler001a.mdl", "models/props_vehicles/generatortrailer01.mdl","models/props_mining/diesel_generator.mdl","models/props_lab/powerbox01a.mdl","models/props/CS_militia/table_shed.mdl","models/props/cs_office/microwave.mdl"}
