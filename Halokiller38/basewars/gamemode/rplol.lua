...
function dropWeapon( ply )
	...
	elseif(ent:GetClass( ) == "weapon_fiveseven2") then
		...
		weapon:SetUpgraded(upgrade)
		weapon:Spawn();
		elseif(ent:GetClass( ) == "weapon_scout") then
		ply:StripWeapon( ent:GetClass( ) )
		local weapon = ents.CreateEx( "spawned_weapon" );
		weapon:SetModel( "models/weapons/w_snip_scout.mdl" );
		weapon:SetNWString("weaponclass", "weapon_scout");
		weapon:SetPos( tr.HitPos );
		weapon:SetUpgraded(upgrade)
		weapon:Spawn();
	...
	elseif(ent:GetClass( ) == "weapon_ump452") then
		...
		weapon:SetUpgraded(upgrade)
		weapon:Spawn();
	elseif(ent:GetClass( ) == "weapon_para") then
		ply:StripWeapon( ent:GetClass( ) )
		local weapon = ents.CreateEx( "spawned_weapon" );
		weapon:SetModel( "models/weapons/w_mach_m249para.mdl" );
		weapon:SetNWString("weaponclass", "weapon_para");
		weapon:SetPos( tr.HitPos );
		weapon:SetUpgraded(upgrade)
		weapon:Spawn();
	...
	elseif(ent:GetClass( ) == "weapon_p902") then
		...
		weapon:SetUpgraded(upgrade)
		weapon:Spawn();
	elseif(ent:GetClass( ) == "weapon_crossbow2") then
		ply:StripWeapon( ent:GetClass( ) )
		local weapon = ents.CreateEx( "spawned_weapon" );
		weapon:SetModel( "models/weapons/w_crossbow.mdl" );
		weapon:SetNWString("weaponclass", "weapon_crossbow2");
		weapon:SetPos( tr.HitPos );
		weapon:SetUpgraded(upgrade)
		weapon:Spawn();
	elseif(ent:GetClass( ) == "ls_sniper") then
		...
		weapon:SetUpgraded(upgrade)
		weapon:Spawn();
	elseif(ent:GetClass( ) == "weapon_sg552") then
		ply:StripWeapon( ent:GetClass( ) )
		local weapon = ents.CreateEx( "spawned_weapon" );
		weapon:SetModel( "models/weapons/w_rif_sg552.mdl" );
		weapon:SetNWString("weaponclass", "weapon_sg552");
		weapon:SetPos( tr.HitPos );
		weapon:SetUpgraded(upgrade)
		weapon:Spawn();
	elseif(ent:GetClass( ) == "weapon_autosnipe") then
		...
		weapon:SetUpgraded(upgrade)
		weapon:Spawn();
	elseif(ent:GetClass( ) == "weapon_sg550") then
		ply:StripWeapon( ent:GetClass( ) )
		local weapon = ents.CreateEx( "spawned_weapon" );
		weapon:SetModel( "models/weapons/w_snip_sg550.mdl" );
		weapon:SetNWString("weaponclass", "weapon_sg550");
		weapon:SetPos( tr.HitPos );
		weapon:SetUpgraded(upgrade)
		weapon:Spawn();
...
function BuyPistol( ply, args )
	...
	if( args == "deagle" ) then
		...
		Notify( ply, 0, 3, "You bought a Desert Eagle!" );
		local weapon = ents.CreateEx( "spawned_weapon" );
		weapon:SetModel( "models/weapons/w_pist_deagle.mdl" );
		weapon:SetNWString("weaponclass", "weapon_deagle2");
		weapon:SetPos( tr.HitPos );
	...
	elseif( args == "elites" || args == "dualies" || args == "baretta" ) then
		...
		Notify( ply, 0, 3, "You bought Duel Elites!" );
		local weapon = ents.CreateEx( "spawned_weapon" );
		weapon:SetModel( "models/weapons/w_pist_elite_dropped.mdl" );
		weapon:SetNWString("weaponclass", "weapon_elites2");
		weapon:SetPos( tr.HitPos );
...
-- Mac-10	
	if( args == "mac10" || args == "mac" ) then
		...
		Notify( ply, 0, 3, "You bought a shipment of Mac10's!" );
...
-- UMP45	
	elseif( args == "ump" || args == "ump45" ) then
		...
		Notify( ply, 0, 3, "You bought a shipment og ump45's!" );
			local weapon = ents.Create( "spawned_shipment" );
...
-- P90	
	elseif( args == "p9" || args == "p90" ) then
		...
		Notify( ply, 0, 3, "You bought a shipment of P90's!" );
			...
			weapon:Spawn();
-- MP7	
	elseif( args == "mp7" || args == "p7" ) then
		if( not ply:CanAfford( 1.5*CfgVars["mp7cost"]*mult ) ) then
			Notify( ply, 4, 3, "Cannot afford this" );
			return "";
		end
		ply:AddMoney( (1.5*CfgVars["mp7cost"]*mult) * -1 );
		Notify( ply, 0, 3, "You bought a shipment of MP7's!" );
			local weapon = ents.Create( "spawned_shipment" );
			weapon.WeaponModel = ( "models/weapons/v_smg1.mdl" );
			weapon:SetNWString("weaponclass", "weapon_mp7");
			weapon:SetNWString("Contents", "MP7 Shipment");
			weapon:SetPos( Vector(tr.HitPos.x, tr.HitPos.y, tr.HitPos.z));
			weapon:Spawn();
-- Crossbow
	elseif( args == "crossbow" || args == "bow" ) then
		if( not ply:CanAfford( 1.5*CfgVars["crossbowcost"]*mult ) ) then
			Notify( ply, 4, 3, "Cannot afford this" );
			return "";
		end
		ply:AddMoney( (1.5*CfgVars["crossbowcost"]*mult) * -1 );
		Notify( ply, 0, 3, "You bought a Shipment of Crossbows!" );
			local weapon = ents.Create( "spawned_shipment" );
			weapon.WeaponModel = ( "models/weapons/w_crossbow.mdl" );
			weapon:SetNWString("weaponclass", "weapon_crossbow");
			weapon:SetNWString("Contents", "Crossbow Shipment");
			weapon:SetPos( Vector(tr.HitPos.x, tr.HitPos.y, tr.HitPos.z));
			weapon:Spawn();
-- M4A1	
	elseif( args == "m4" || args == "m16" ) then
		...
		Notify( ply, 0, 3, "You bought a shipment of M4A1's!" );
			local weapon = ents.Create( "spawned_shipment" );
			...
			weapon:Spawn();
-- Scout	
	elseif( args == "scout" || args == "snipe" ) then
		if( not ply:CanAfford( 1.5*CfgVars["scoutcost"]*mult ) ) then
			Notify( ply, 4, 3, "Cannot afford this" );
			return "";
		end
		ply:AddMoney( (1.5*CfgVars["scoutcost"]*mult) * -1 );
		Notify( ply, 0, 3, "You bought a shipment of Scouts!" );
			local weapon = ents.Create( "spawned_shipment" );
			weapon.WeaponModel = ( "models/weapons/w_snip_scout.mdl" );
			weapon:SetNWString("weaponclass", "weapon_scout");
			weapon:SetNWString("Contents", "Scout Shipment");
			weapon:SetPos( Vector(tr.HitPos.x, tr.HitPos.y, tr.HitPos.z));
			weapon:Spawn();
-- Famas	
	elseif( args == "famas" || args == "fama" ) then
		if( not ply:CanAfford( 1.5*CfgVars["famascost"]*mult ) ) then
			Notify( ply, 4, 3, "Cannot afford this" );
			return "";
		end
		ply:AddMoney( (1.5*CfgVars["famascost"]*mult) * -1 );
		Notify( ply, 0, 3, "You bought a shipment of Famas'!" );
			local weapon = ents.Create( "spawned_shipment" );
			weapon.WeaponModel = ( "models/weapons/w_rif_famas.mdl" );
			weapon:SetNWString("weaponclass", "weapon_famas");
			weapon:SetNWString("Contents", "Famas Shipment");
			weapon:SetPos( Vector(tr.HitPos.x, tr.HitPos.y, tr.HitPos.z));
			weapon:Spawn();
--Para
	elseif( args == "para" || args == "m249" ) then
		if( not ply:CanAfford( 1.5*CfgVars["paracost"]*mult ) ) then
			Notify( ply, 4, 3, "Cannot afford this" );
			return "";
		end
		ply:AddMoney( (1.5*CfgVars["paracost"]*mult) * -1 );
		Notify( ply, 0, 3, "You bought a shipment of Para's" );
			local weapon = ents.Create( "spawned_shipment" );
			weapon.WeaponModel = ( "models/weapons/w_mach_m249para.mdl" );
			weapon:SetNWString("weaponclass", "weapon_para");
			weapon:SetNWString("Contents", "Para Shipment");
			weapon:SetPos( Vector(tr.HitPos.x, tr.HitPos.y, tr.HitPos.z));
			weapon:Spawn();
-- Pump Shotgun
...
-- MP5
	elseif( args == "mp5" || args == "mp" ) then
		...
		Notify( ply, 0, 3, "You bought a shipment of MP5's!" );
			local weapon = ents.Create( "spawned_shipment" );
...
-- Galil
	elseif( args == "galil" || args == "gal" ) then
		...
		Notify( ply, 0, 3, "You bought a shipment of Galil's!" );
			local weapon = ents.Create( "spawned_shipment" );
...
-- AUG
	elseif( args == "aug" || args == "augy" ) then
		...
		Notify( ply, 0, 3, "You bought a shipment of AUG's!" );
			local weapon = ents.Create( "spawned_shipment" );
...
-- Ak47
	elseif( args == "ak47" || args == "ak" ) then
		...
		Notify( ply, 0, 3, "You bought a shipment of AK47's!" );
			local weapon = ents.Create( "spawned_shipment" );
...
-- Auto Shotgun
	elseif( args == "autoshotgun" || args == "noobcannon" || args=="m1014" || args=="xm1014" || args== "autoshotty") then
		...
		Notify( ply, 0, 3, "You bought a shipment of Auto-Shotguns" );
			local weapon = ents.Create( "spawned_shipment" );
...
-- Auto Sniper
	elseif( args == "autosniper" || args == "autosnipe" || args == "psg1" || args=="g3" || args=="g3sg1") then
		...
		Notify( ply, 0, 3, "You bought a shipment of Auto Sniper Rifles!" );
			local weapon = ents.Create( "spawned_shipment" );
...
-- Sg550
	elseif( args == "sg550" ) then
		if( not ply:CanAfford( 1.5*CfgVars["sg550ecost"]*mult ) ) then
			Notify( ply, 4, 3, "Cannot afford this" );
			return "";
		end
		ply:AddMoney( (1.5*CfgVars["sg550cost"]*mult) * -1 );
		Notify( ply, 0, 3, "You bought a shipment of SG550 Rifles!" );
			local weapon = ents.Create( "spawned_shipment" );
			weapon.WeaponModel = ( "models/weapons/w_snip_sg550.mdl" );
			weapon:SetNWString("weaponclass", "weapon_sg550");
			weapon:SetNWString("Contents", "SG550 Shipment");
			weapon:SetPos( Vector(tr.HitPos.x, tr.HitPos.y, tr.HitPos.z));
			weapon:Spawn();
-- Sg550
	elseif( args == "sg552" ) then
		if( not ply:CanAfford( 1.5*CfgVars["sg552ecost"]*mult ) ) then
			Notify( ply, 4, 3, "Cannot afford this" );
			return "";
		end
		ply:AddMoney( (1.5*CfgVars["sg552cost"]*mult) * -1 );
		Notify( ply, 0, 3, "You bought a shipment of SG552 Rifles!" );
			local weapon = ents.Create( "spawned_shipment" );
...
function BuyWeapon( ply, args )
	...
	elseif( args == "aug") then
		...
		if( not ply:CanAfford( CfgVars["miniguncost"]*.5 ) ) then
			Notify( ply, 4, 3, "Cannot afford this" );
			return "";
		end
		ply:AddMoney( (CfgVars["miniguncost"]*.5) * -1 );
		Notify( ply, 0, 3, "You bought a Minigun!" );
		
			local weapon = ents.CreateEx( "spawned_weapon" );
			weapon:SetModel( "models/weapons/w_models/w_minigun.mdl" );
			weapon:SetNWString("weaponclass", "weapon_mad_minigun");
			weapon:SetPos( Vector(tr.HitPos.x, tr.HitPos.y + (10), tr.HitPos.z));
			weapon:Spawn();
	...
	elseif( args == "spasr") then
		if( not ply:CanAfford( CfgVars["spascost"]*.5 ) ) then
			Notify( ply, 4, 3, "Cannot afford this" );
			return "";
		end
		ply:AddMoney( (CfgVars["spascost"]*.5) * -1 );
		Notify( ply, 0, 3, "You bought a SPAS 12 !" );
		
			local weapon = ents.CreateEx( "spawned_weapon" );
			weapon:SetModel( "models/weapons/w_spas12_shotgun.mdl" );
			weapon:SetNWString("weaponclass", "weapon_spas_12");
			weapon:SetPos( Vector(tr.HitPos.x, tr.HitPos.y + (10), tr.HitPos.z));
			weapon:Spawn();
			
			elseif( args == "mp7") then
		if( not ply:CanAfford( CfgVars["mp7cost"]*.5 ) ) then
			Notify( ply, 4, 3, "Cannot afford this" );
			return "";
		end
		ply:AddMoney( (CfgVars["mp7"]*.5) * -1 );
	...
	elseif( args == "mp5" || args== "mp5navy" ) then
		...
		Notify( ply, 0, 3, "You bought an MP5!" );
	...
	elseif( args == "scout") then
		if( not ply:CanAfford( CfgVars["scoutcost"]*.5 ) ) then
			Notify( ply, 4, 3, "Cannot afford this" );
			return "";
		end
		ply:AddMoney( CfgVars["scoutcost"]*.5 * -1 );
		Notify( ply, 0, 3, "You bought a Scout!" );
	...
	elseif( args == "famas") then
		if( not ply:CanAfford( CfgVars["famascost"]*.5 ) ) then
			Notify( ply, 4, 3, "Cannot afford this" );
			return "";
		end
		ply:AddMoney( CfgVars["famascost"]*.5 * -1 );
	...
	elseif( args == "crossbow") then
		if( not ply:CanAfford( CfgVars["crossbowcost"]*.5 ) ) then
			Notify( ply, 4, 3, "Cannot afford this" );
			return "";
		end
		ply:AddMoney( CfgVars["crossbowcost"]*.5 * -1 );
		Notify( ply, 0, 3, "You bought a Crossbow!" );
	...
	elseif( args == "m16" || args == "m4") then
		...
		Notify( ply, 0, 3, "You bought an M4A1!" );
	...
	elseif( args == "shotgun" || args == "pumpshotgun") then
		...
		Notify( ply, 0, 3, "You bought a Pump Shotgun!" );
	...
	elseif( args == "sg550" || args == "Sg550" || args == "SG550" ) then
		if( not ply:CanAfford( CfgVars["sg550cost"]*.5 ) ) then
			Notify( ply, 4, 3, "Cannot afford this" );
			return "";
		end
		ply:AddMoney( CfgVars["sg550cost"]*.5 * -1 );
		Notify( ply, 0, 3, "You bought a SG550 rifle!" );
	...
	elseif( args == "sg552" || args == "Sg552" || args == "SG552" ) then
		if( not ply:CanAfford( CfgVars["sg552cost"]*.5 ) ) then
			Notify( ply, 4, 3, "Cannot afford this" );
			return "";
		end
		ply:AddMoney( CfgVars["sg552cost"]*.5 * -1 );
		Notify( ply, 0, 3, "You bought a SG552 rifles!" );
...
--			weapon:Spawn();
	...
	elseif( args == "flashbang" || args == "stungrenade" || args == "stun" || args == "flash" ) then
		...
		Notify( ply, 0, 3, "You bought a Flashbang grenade!" );
	...
	elseif( args == "smoke" || args == "smoke grenade" || args=="smokey" || args=="Smoke" || args =="Smoke Grenade") then
		if( not ply:CanAfford( CfgVars["smokecost"]*.5 ) ) then
			Notify( ply, 4, 3, "Cannot afford this" );
			return "";
		end
		ply:AddMoney( CfgVars["smokecost"]*.5 * -1 );
		Notify( ply, 0, 3, "You bought a smoke grenade!" );
		
			local weapon = ents.CreateEx( "spawned_weapon" );
			weapon:SetModel( "models/weapons/w_eq_smokegrenade.mdl" );
			weapon:SetNWString("weaponclass", "weapon_smoke");
			weapon:SetPos( Vector(tr.HitPos.x, tr.HitPos.y + (10), tr.HitPos.z));
			weapon:Spawn();
...
---------------------------LmaoLlama Grenade Shipments Start--------------------------------------------------
--Sticky
...
--Inced
	...
	elseif( args == "c4" || args == "c4charge") then
		...
		Notify( ply, 0, 3, "You bought a C4 Explosive!" );
			...
			weapon:Spawn();
	--c4
	elseif( args == "smoke" || args == "smoke grenade") then
...
---------------------------LmaoLlamaBaseWarsV2/ments End--------------------------------------------------
	elseif( args == "grenade"  || args == "frag" || args == "fraggrenade" ) then
		...
		Notify( ply, 0, 3, "You bought a shipment of frag grenades!" );
		for i=-1, 1, 1 do 
			local weapon = ents.Create( "spawned_weapon" );
	...
	elseif( args == "pipebomb"  || args == "pipe" || args == "pipez" ) then
		if( not ply:CanAfford( CfgVars["pipebombcost"]*mult ) ) then
			Notify( ply, 4, 3, "Cannot afford this" );
			return "";
		end
		ply:AddMoney( CfgVars["pipebombcost"]*mult * -1 );
		Notify( ply, 0, 3, "You bought a shipment of Pipebombs!" );
		for i=-1, 1, 1 do 
			local weapon = ents.Create( "spawned_weapon" );
...
function BuyGunvault( ply )
	...
	local tr = util.TraceLine( trace );
		...
		if(ply:GetTable().maxvault >= CfgVars["maxgunvaults"])then
			Notify( ply, 4, 3, "Max Gun Vaults/Pillboxes Reached!" );
			return "";
		end
...
function BuyIncedAmmo( ply )
	...
	local tr = util.TraceLine( trace );
		...
		ply:AddMoney( -500 );
		Notify( ply, 0, 3, "You bought Incendiary Ammo" );
...
function BuyHealth( ply )
	...
	Notify(ply, 0, 3, "You bought a Med Kit!")
	local trace = { }
...
function BuyNWeapons( ply, args )
	...
	elseif( args == "grenade"  || args == "frag" || args == "fraggrenade" ) then
		...
		ply:AddMoney( CfgVars["grenadecost"]*mult * -1 );
		Notify( ply, 0, 3, "You bought a Frag Grenade!" );
		for i=-3, 3, 1 do 
			local weapon = ents.CreateEx( "spawned_weapon" );
			weapon:SetModel( "models/weapons/w_eq_fraggrenade.mdl" );
			weapon:SetNWString("weaponclass", "cse_eq_hegrenade");
	...
	elseif( args == "molotov"  || args == "firebomb") then
		Notify( ply, 0, 3, "Molotovs Are Now Enabled!" );
