...
ITEM.name = "Ration (MRE)"; -- The name of the item, obviously.
ITEM.cost = 2; -- How much does this item cost for people with business access to it?
ITEM.model = "models/weapons/w_package.mdl"; -- What model does the item use.
ITEM.weight = 0.2; -- How much does it weigh in kg?
...
ITEM.category = "Food"; -- What category does the item belong in?
ITEM.business = true; -- Is this item available on the business menu (if the player has access to it)?
ITEM.description = "The best part about waking up, is folgers in your cup. Not this, but the beef is alright for a ration."; -- Give a small description of the item.
...
function ITEM:OnUse(player, itemEntity)
	player:SetHealth( math.Clamp( player:Health() + 25, 0, player:GetMaxHealth() ) ); -- copy pasta
