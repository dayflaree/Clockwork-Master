...
ITEM.name = "Tactical Webbing"; -- The name of the item, obviously.
ITEM.model = "models/Items/hevsuit.mdl"; -- What model does the item use. to do l8r
ITEM.weight = 2; -- How much does it weigh in kg?
ITEM.category = "Storage";
ITEM.uniqueID = "tacwebbing"
ITEM.isRareItem = true; -- What category does the item belong in?
ITEM.description = "Commonly used throughout the galaxy, this webbing features an even weight distribution system, and add roughly 40 kilograms of carrying capacity."; -- Give a small description of the item.
ITEM.extraInventory = 80; -- How much extra inventory do you get for having this item (advised that you add the weight to it).
...
function ITEM:OnCreateDropEntity(player, position)
	return nexus.entity.CreateItem(player, "boxed_tacwebbing", position);
end;
