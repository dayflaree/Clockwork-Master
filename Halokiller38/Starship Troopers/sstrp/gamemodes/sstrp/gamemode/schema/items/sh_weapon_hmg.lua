...
ITEM.name = "Federation Heavy Machinegun"; -- The name of the item, obviously.
ITEM.cost = 6500; -- How much does this item cost for people with business access to it?
ITEM.model = "models/weapons/w_bianchi.mdl"; -- What model does the item use.
...
ITEM.uniqueID = "nx_hmg"; -- Optionally, you can manually set a unique ID for an item, but usually you don't need to.
ITEM.business = true; -- Is this item available on the business menu (if the player has access to it)?
ITEM.description = "Utilizes 150 drum magazines, built from lightweight synthetic polymers and alloys, featuring a holographic sight and uses entirely modular and replaceable parts, this weapon is mainly used for suppressive fire."; -- Give a small description of the item.
