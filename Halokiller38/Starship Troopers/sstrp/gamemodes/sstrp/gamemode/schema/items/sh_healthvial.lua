...
ITEM.name = "Healthvial"; -- The name of the item, obviously.
ITEM.cost = 10; -- How much does this item cost for people with business access to it?
ITEM.model = "models/healthvial.mdl"; -- What model does the item use.
...
ITEM.description = "A standard mobile infantry medical kit, contains blood coagulants, along with experimental wound regeneration chemicals used commonly throughout the universe."; -- Give a small description of the item.
