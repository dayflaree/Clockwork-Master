...
ITEM.name = "Boxed Tactical Webbing"; -- The name of the item, obviously.
ITEM.cost = 400; -- How much does this item cost for people with business access to it?
ITEM.model = "models/Items/item_item_crate.mdl"; -- What model does the item use.
...
function ITEM:OnUse(player, itemEntity)
	...
	if (player:HasItem("tacwebbing") and player:HasItem("tacwebbing") >= 1) then
		nexus.player.Notify(player, "Can only wear one set of tactical webbing you nimrod.");
