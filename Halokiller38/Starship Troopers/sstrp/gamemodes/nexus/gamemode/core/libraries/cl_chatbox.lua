		...
		if ( !NEXUS:IsChoosingCharacter() ) then
			if (speaker:Name() != "") then
				...
				if (info.visible) then
					...
					elseif (info.class == "mc" ) then
						nexus.chatBox.Add(info.filtered, nil, Color(0, 90, 150, 255), "[", Color(128, 100, 152, 255), "MOBILE COMMAND", Color(0, 90, 150, 255), "]", Color(128, 100, 152, 255), ": " .. info.text);
					elseif (info.class == "radio") then
						nexus.chatBox.Add(info.filtered, nil, Color(75, 150, 50, 255), info.name.." radios in \""..info.text.."\"");
					elseif (info.class == "of") then
						nexus.chatBox.Add(info.filtered, nil, Color(53, 99, 124, 255), info.name.." radios in to officers \""..info.text.."\"");
					elseif (info.class == "bc") then
						nexus.chatBox.Add(info.filtered, nil, Color(150, 0, 0, 255), info.name.." broadcasts on all channels, \""..info.text.."\"");
						RunConsoleCommand("play", "common/bugreporter_succeeded.wav")
