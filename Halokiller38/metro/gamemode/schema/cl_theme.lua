...
function THEME:CreateFonts()
	surface.CreateFont("Dirty Ego", ScaleToWideScreen(2048), 500, true, false, "sev_Large3D2D");
	surface.CreateFont("Dirty Ego", ScaleToWideScreen(31), 500, true, false, "sev_IntroTextSmall");
	surface.CreateFont("Dirty Ego", ScaleToWideScreen(24), 500, true, false, "sev_IntroTextTiny");
	surface.CreateFont("Dirty Ego", ScaleToWideScreen(36), 500, true, false, "sev_CinematicText");
	surface.CreateFont("Dirty Ego", ScaleToWideScreen(78), 500, true, false, "sev_IntroTextBig");
	surface.CreateFont("Dirty Ego", ScaleToWideScreen(24), 500, true, false, "sev_TargetIDText");
	surface.CreateFont("Dirty Ego", ScaleToWideScreen(126), 500, true, false, "sev_MenuTextHuge");
	surface.CreateFont("Dirty Ego", ScaleToWideScreen(78), 500, true, false, "sev_MenuTextBig");
	surface.CreateFont("Dirty Ego", ScaleToWideScreen(20), 500, true, false, "sev_MainText");
...
function THEME:Initialize()
	openAura.option:SetColor( "information", Color(150, 25, 25, 255) );
