...
function ENT:HUDPaintTargetID(x, y, alpha)
	...
	y = NEXUS:DrawInfo("Radio", x, y, colorTargetID, alpha);
	
	if (frequency == "") then
		y = NEXUS:DrawInfo("This radio has no frequency.", x, y, colorWhite, alpha);
	else
		y = NEXUS:DrawInfo(frequency, x, y, colorWhite, alpha);
	end;
end;
