...
nexus.setting.AddNumberSlider("Framework", "How much headbob to simulate.", "nx_headbobscale", 0, 1, 1, "The amount to scale the headbob by.");
...
nexus.setting.AddCheckBox("Framework", "Enable the admin console log.", "nx_showlog", "Whether or not to show the admin console log.", function()
	return nexus.player.IsAdmin(g_LocalPlayer);
end);

nexus.setting.AddCheckBox("Framework", "Enable the twelve hour clock.", "nx_twelvehourclock", "Whether or not to show a twelve hour clock.");
nexus.setting.AddCheckBox("Framework", "Enable the hints system.", "nx_showhints", "Whether or not to show you any hints.");
...
nexus.setting.AddCheckBox("Framework", "Enable the admin ESP.", "nx_adminesp", "Whether or not to show the admin ESP.", function()
	return nexus.player.IsAdmin(g_LocalPlayer);
end);