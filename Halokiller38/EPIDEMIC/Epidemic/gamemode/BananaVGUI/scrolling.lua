...
function VBAR:Init()
	...
	self.DragMode = false;
	self.DragMouseY = 0;
	self.HighlightColor = Color( 80, 80, 80, 255 );
	self.Color = Color( 40, 40, 40, 255 );
...
function VBAR:CalculateBar()
	...
	local height = math.Clamp( maxscrollbarheight - scrollamount, 12, maxscrollbarheight );
...
function VBAR:Paint()
	...
	draw.RoundedBox( 0, 0, 0, self:GetWide(), self:GetTall(), Color( 255, 255, 255, 150 ) );
