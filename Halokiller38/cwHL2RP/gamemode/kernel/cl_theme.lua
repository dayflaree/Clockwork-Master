...
function THEME:CreateFonts()
	surface.CreateFont("OldNewspaperTypes", ScaleToWideScreen(2048), 600, true, false, "test_Large3D2D");
	surface.CreateFont("OldNewspaperTypes", ScaleToWideScreen(36), 600, true, false, "test_IntroTextSmall");
	surface.CreateFont("OldNewspaperTypes", ScaleToWideScreen(26), 600, true, false, "test_IntroTextTiny");
	surface.CreateFont("OldNewspaperTypes", ScaleToWideScreen(36), 600, true, false, "test_CinematicText");
	surface.CreateFont("OldNewspaperTypes", ScaleToWideScreen(78), 600, true, false, "test_IntroTextBig");
	surface.CreateFont("OldNewspaperTypes", ScaleToWideScreen(26), 600, true, false, "test_TargetIDText");
	surface.CreateFont("OldNewspaperTypes", ScaleToWideScreen(16), 600, true, false, "test_SmallBarText");
	surface.CreateFont("OldNewspaperTypes", ScaleToWideScreen(126), 600, true, false, "test_MenuTextHuge");
	surface.CreateFont("OldNewspaperTypes", ScaleToWideScreen(78), 600, true, false, "test_MenuTextBig");
	surface.CreateFont("OldNewspaperTypes", ScaleToWideScreen(22), 600, true, false, "test_PlayerInfoText");
	surface.CreateFont("OldNewspaperTypes", ScaleToWideScreen(24), 600, true, false, "test_MainText");
end;

-- Called when to initialize theme.
function THEME:Initialize()
	Clockwork.option:SetColor("information", Color(121, 168, 255, 255));
	Clockwork.option:SetColor("background", Color(0, 25, 65, 255));
	Clockwork.option:SetColor("target_id", Color(38, 116, 189, 255));
...
THEME.skin.frameBorder = Color(38, 116, 189, 255);
THEME.skin.frameTitle = Color(38, 116, 189, 255);

THEME.skin.bgColorBright = Color(38, 116, 189, 255);
THEME.skin.bgColorSleep = Color(0, 40, 77, 255);
THEME.skin.bgColorDark = Color(0, 18, 32, 255);
THEME.skin.bgColor = Color(0, 25, 31, 225);

THEME.skin.controlColorHighlight = Color(70, 70, 70, 255);
THEME.skin.controlColorActive = Color(10, 29, 70, 255);
THEME.skin.controlColorBright = Color(1, 10, 31, 255);
THEME.skin.controlColorDark = Color(0, 0, 30, 255);
THEME.skin.controlColor = Color(0, 0, 60, 255);

THEME.skin.colTabTextInactive = Color(65, 163, 255, 255);
THEME.skin.colPropertySheet = Color(65, 163, 255, 255);
THEME.skin.colTabInactive = Color(0, 0, 0, 255);
THEME.skin.colTabShadow = Color(0, 45, 87, 170);
THEME.skin.colTabText = Color(255, 255, 255, 255);
THEME.skin.colTab = Color(38, 116, 189, 255);
...
function THEME.skin:SchemeForm(panel)
	...
	panel.Label:SetTextColor(Color(101, 187, 231, 255));
...
function THEME.skin:PaintListView(panel)
	if (panel.m_bBackground) then
		surface.SetDrawColor(101, 187, 231, 255);
...
function THEME.skin:PaintListViewLine(panel)
	...
	local textColor = Color(101, 187, 231, 255);
	
	if (panel:IsSelected()) then
		color = Color(101, 187, 231, 255);
...
function THEME.skin:SchemeListViewLabel(panel)
	...
	panel:SetTextColor(Color(101, 187, 231, 255));
end;
...
function THEME.skin:SchemeMenuOption(panel)
	panel:SetFGColor(101, 187, 231, 255);
end;
...
function THEME.skin:PaintButton(panel)
	...
	if (panel.m_bBackground) then
		...
		local borderColor = Color(0, 140, 213, 255);
...
function THEME.skin:PaintScrollBarGrip(panel)
	local w, h = panel:GetSize();
	local color = Color(101, 187, 231, 255);
