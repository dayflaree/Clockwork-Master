--[[
Name: "sh_vehicle_insurgency.lua".
Product: "Novus Two".
--]]
...
ITEM.name = "Civilian Insurgency Tacoma";
ITEM.class = "prop_vehicle_jeep";
ITEM.model = "models/tacoma6.mdl";
ITEM.calcView = Vector(0, 0, 8);
ITEM.seatType = "Seat_Jeep";
ITEM.hideSeats = true;
ITEM.description = "A dirty Tacoma, it can hold eight people.";
ITEM.vehiclePhysDesc = "A dirty Tacoma with Civilian Insurgency on the side.";
