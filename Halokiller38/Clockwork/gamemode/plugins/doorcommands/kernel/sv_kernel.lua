...
function PLUGIN:LoadParentData()
	...
	local parentData = Clockwork:RestoreSchemaData("plugins/parents/"..game.GetMap());
	local positions = {};
...
function PLUGIN:LoadDoorData()
	...
	local positions = {};
	local doorData = Clockwork:RestoreSchemaData("plugins/doors/"..game.GetMap());
...
function PLUGIN:SaveParentData()
	...
	Clockwork:SaveSchemaData("plugins/parents/"..game.GetMap(), parentData);
end;
...
function PLUGIN:SaveDoorData()
	...
	Clockwork:SaveSchemaData("plugins/doors/"..game.GetMap(), doorData);
end;