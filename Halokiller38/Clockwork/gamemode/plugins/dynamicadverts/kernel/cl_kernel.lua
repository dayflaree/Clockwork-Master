...
Clockwork:HookDataStream("DynamicAdverts", function(data)
	local PLUGIN = Clockwork.plugin:FindByID("Dynamic Adverts");
...
Clockwork:HookDataStream("DynamicAdvertAdd", function(data)
	local PLUGIN = Clockwork.plugin:FindByID("Dynamic Adverts");
...
Clockwork:HookDataStream("DynamicAdvertRemove", function(data)
	local PLUGIN = Clockwork.plugin:FindByID("Dynamic Adverts");
