...
Clockwork.setting = Clockwork:NewLibrary("Setting");
...
//Clockwork.setting:AddNumberSlider("Framework", "How much headbob to simulate.", "cwHeadbobScale", 0, 1, 1, "The amount to scale the headbob by.");
Clockwork.setting:AddNumberSlider("Chat Box", "How many chat lines should show.", "cwMaxChatLines", 1, 10, 0, "The amount of chat lines shown at once.");
