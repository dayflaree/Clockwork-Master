...
Clockwork.config:Add("enable_temporary_damage", true);
...
Clockwork.config:Add("generator_interval", 720);
...
Clockwork.config:Add("default_cash", 40);
...
Clockwork.config:Add("wages_interval", 720);
...
Clockwork.config:Add("scale_head_dmg", 4);
