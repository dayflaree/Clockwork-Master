...
SWEP.Author			= "Hulk Hogan"
SWEP.Contact		= "hulkhogan@hotmail.com"
SWEP.Purpose		= "No purpose entered"
SWEP.Instructions	= "No instructions entered"
...
function SWEP:SecondaryAttack()
	...
	self.Weapon:SendWeaponAnim( 178 )
