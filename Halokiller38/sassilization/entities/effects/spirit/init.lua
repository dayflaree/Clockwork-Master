...
local matSoul 	= Material( "sassilization/soul" )
...
function EFFECT:Init( data )
	...
	self.Alpha = 255
	self.Speed = Vector( 0, 0, math.Rand( 4, 6 ) )
...
function EFFECT:Render()
	...
	render.DrawQuadEasy( Pos, EyeNormal, 4, 8*self.Size, Color( 255, 255, 255, self.Alpha ), Rot )
	render.DrawQuadEasy( Pos, EyeNormal, 4, 8*self.Size, Color( 0, 255, 0, self.Alpha * math.Rand( 0, 0.5 ) ), Rot )
