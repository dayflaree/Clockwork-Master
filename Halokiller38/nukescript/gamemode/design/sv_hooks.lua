...
function DESIGN:GetPlayerDefaultInventory(player, character, inventory)
	if (character.faction == FACTION_NCR) then
		...
		inventory["fo3_custom_assaultrifle"] = 1;
	...
	elseif (character.faction == FACTION_RAIDER) then
		inventory["handheld_radio"] = 1;
		inventory["rcs_uspmatch"] = 1;
		inventory["fo3_chinese_assault_rifle"] = 1;
		inventory["ammo_pistol"] = 2;
		inventory["ammo_smg1"] = 2;
		inventory["backpack"] = 1;
		inventory["jacket"] = 1;
	elseif (character.faction == FACTION_ALIENS) then
		inventory["fo3_alienblaster"] = 1;
		inventory["rcs_uspmatch"] = 1;
		inventory["ammo_pistol"] = 3;
		inventory["ammo_smg1"] = 3;
		inventory["backpack"] = 1;
		inventory["jacket"] = 1;	
	elseif (character.faction == FACTION_BOS) then
		inventory["fo3_laserrifle"] = 1;
		inventory["rcs_uspmatch"] = 1;
		inventory["ammo_pistol"] = 3;
		inventory["ammo_combinecannon"] = 3;
		inventory["backpack"] = 1;
		inventory["jacket"] = 1;	
	elseif (character.faction == FACTION_RANGER) then
		inventory["rcs_awp"] = 1;
		inventory["rcs_uspmatch"] = 1;
		inventory["ammo_pistol"] = 3;
		inventory["ammo_ar2"] = 3;
		inventory["backpack"] = 1;
		inventory["jacket"] = 1;	
	elseif (character.faction == FACTION_DRANGER) then
		inventory["rcs_awp"] = 1;
		inventory["rcs_uspmatch"] = 1;
		inventory["ammo_pistol"] = 3;
		inventory["ammo_ar2"] = 3;
	...
	elseif (character.faction == FACTION_ENCLAVE) then
		inventory["fo3_plasmarifle"] = 1;
		inventory["rcs_uspmatch"] = 1;
		inventory["ammo_pistol"] = 3;
		inventory["ammo_HeliCopterGun"] = 3;
		inventory["backpack"] = 1;
		inventory["jacket"] = 1;	
	else
		inventory["rcs_uspmatch"] = 1;
