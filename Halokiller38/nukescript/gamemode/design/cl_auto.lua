...
surface.CreateFont("Overseer Oblique", ScaleToWideScreen(2048), 600, true, false, "nov_Large3D2D");
surface.CreateFont("Overseer Oblique", ScaleToWideScreen(31), 600, true, false, "nov_IntroTextSmall");
surface.CreateFont("Overseer Oblique", ScaleToWideScreen(24), 600, true, false, "nov_IntroTextTiny");
surface.CreateFont("Overseer Oblique", ScaleToWideScreen(36), 600, true, false, "nov_CinematicText");
surface.CreateFont("Overseer Oblique", ScaleToWideScreen(78), 600, true, false, "nov_IntroTextBig");
surface.CreateFont("Overseer Oblique", ScaleToWideScreen(24), 600, true, false, "nov_TargetIDText");
surface.CreateFont("Verdana", ScaleToWideScreen(17), 600, true, false, "nov_ChatBoxText");
surface.CreateFont("Overseer Oblique", ScaleToWideScreen(126), 600, true, false, "nov_MenuTextHuge");
surface.CreateFont("Overseer Oblique", ScaleToWideScreen(78), 600, true, false, "nov_MenuTextBig");
surface.CreateFont("Overseer Oblique", ScaleToWideScreen(20), 600, true, false, "nov_MainText");
