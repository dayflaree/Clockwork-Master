...
blueprint.config.Add("intro_text_small", "They said the west was safer, they lied.", true);
blueprint.config.Add("intro_text_big", "NEVEDA, 2281.", true);
...
blueprint.hint.Add("Danger", "Remember, danger lurks around every corner!")
blueprint.hint.Add("Careful", "Careful who you travel with, don't want to be robbed.")
blueprint.hint.Add("Radiation", "If you hear a tick tick, get the hell out of there.")
