...
openAura.config:Add("intro_text_small", "5 years since the Reactor blew up.", true);
openAura.config:Add("intro_text_big", "Chernobyl, Ukraine, 1991", true);
...
openAura.config:Get("wages_interval"):Set(3600);
openAura.config:Get("disable_sprays"):Set(false);


openAura.config:Get("ooc_interval"):Set(500);
openAura.config:Get("default_cash"):Set(10);
...
openAura.hint:Add("Errors", "Seeing errors? Make sure you've downloaded the content");
openAura.hint:Add("Military", "The military doesn't like that you're here, so don't try to make conversation.");
