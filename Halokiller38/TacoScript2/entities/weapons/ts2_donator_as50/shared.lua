...
SWEP.WorldModel = "models/weapons/w_as_50.mdl";
SWEP.ViewModel = "models/weapons/v_as50_awp.mdl";

SWEP.PrintName = "AS-5O Rifle";
...
SWEP.Primary.IronSightPos = Vector( -6.4,  -9.0 , 2.5 );
