...
SWEP.WorldModel = "models/weapons/w_l86.mdl";
SWEP.ViewModel = "models/weapons/v_l86_rif.mdl";

SWEP.PrintName = "LA86";
SWEP.TS2Desc = "British Army Assault Rifle";
...
SWEP.Primary.SpreadCone = Vector( 0.03, 0.03, 0.03 );
 ...
 SWEP.Primary.IronSightPos = Vector(5.2831, 0.0891, -14.499  );
