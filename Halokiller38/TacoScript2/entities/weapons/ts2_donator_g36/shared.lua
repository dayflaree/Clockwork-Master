...
SWEP.ViewModel		= "models/weapons/v_stalker36.mdl";
SWEP.WorldModel		= "models/weapons/w_g36_rat.mdl";

SWEP.PrintName = "G36K";
SWEP.TS2Desc = "HK Assault Rifle - Donator Weapon";
...
SWEP.Primary.SpreadCone = Vector( 0.03, 0.03, 0.03 );
 ...
 SWEP.Primary.IronSightPos = Vector(3.934, 1.57, -4.8254  );
