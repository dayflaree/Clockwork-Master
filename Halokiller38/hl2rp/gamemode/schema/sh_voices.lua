...
function openAura.schema:AddVoice(faction, command, phrase, sound, female, menu, flag)
...
function openAura.schema:AddVoice(faction, command, phrase, sound)
	self.voices[#openAura.schema.voices + 1] = {
		command = command,
		faction = faction,
		phrase = phrase,
...
//Add sounds with specific flags:
//openAura.schema:AddVoice(FACTION NAME, COMMAND, ACTUAL VOICE, SOUND, MENU, FLAG);
//Example (female citizen):
openAura.schema:AddVoice("Citizen", "You all over", "That's you all over.", "npc/vo/male01/answer01.wav", false, false, "D");
openAura.schema:AddVoice("Citizen", "Hold it against you", "I won't hold it against you.", "npc/vo/male01/answer02.wav", false, false, "D");
openAura.schema:AddVoice("Citizen", "Figures", "Figures", "npc/vo/male01/answer03.wav", false, false, "D");
openAura.schema:AddVoice("Citizen", "Try not to dwell", "Try not to dwell on it.", "npc/vo/male01/answer04.wav", false, false, "D");
openAura.schema:AddVoice("Citizen", "Talk about this later", "Can we talk about this later?", "npc/vo/male01/answer05.wav", false, false, "D");
openAura.schema:AddVoice("Citizen", "Same", "Same here.", "npc/vo/male01/answer07.wav", false, false, "D");
openAura.schema:AddVoice("Citizen", "Know what you mean.", "Know what you mean.", "npc/vo/male01/answer08.wav", false, false, "D");
openAura.schema:AddVoice("Citizen", "You never know", "You never know.", "npc/vo/male01/answer22.wav", false, false, "D");
openAura.schema:AddVoice("Citizen", "Talking to me", "You talking to me?", "npc/vo/male01/answer30.wav", false, false, "D");
openAura.schema:AddVoice("Citizen", "Right on", "Right on!", "npc/vo/male01/answer32.wav", false, false, "D");
openAura.schema:AddVoice("Citizen", "Combine", "Combine!", "npc/vo/male01/combine01.wav", false, false, "D");
openAura.schema:AddVoice("Citizen", "CP", "CPs!", "npc/vo/male01/cps02.wav", false, false, "D");
openAura.schema:AddVoice("Citizen", "Excuse Me", "Excuse me.", "npc/vo/male01/excuseme02.wav", false, false, "D");
openAura.schema:AddVoice("Citizen", "Excuse Me", "Excuse me.", "npc/vo/male01/excuseme02.wav", false, false, "D");
