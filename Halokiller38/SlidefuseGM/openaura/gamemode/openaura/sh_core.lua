...
if (SERVER) then
	...
	function openAura:SchemaDataExists(fileName)
		return _file.Exists("../settings/openaura/schemas/"..self:GetSchemaFolder().."/"..fileName..".aura");
	end;
	...
	function openAura:OpenAuraDataExists(fileName)
		return _file.Exists("../settings/openaura/"..fileName..".aura");
	end;
