...
ITEM.name = "Elite Mercenarie Base";
ITEM.model = "models/stalkertnb/outfits/exo_merc.mdl";
ITEM.batch = 1;
ITEM.weight = 7.0;
ITEM.useText = "Wear";
ITEM.business = true;
...
ITEM.description = "The Whole Elite Mercenarie Suit.";
...
function ITEM:OnUse(player, itemEntity)
	if ( player:Alive() and !player:IsRagdolled() ) then
		...
		or openAura.player:GetFaction(player) == FACTION_MONOLITH) then
			...
			openAura.player:Notify(player, "You cannot wear these clothes!");
		end;
	else
