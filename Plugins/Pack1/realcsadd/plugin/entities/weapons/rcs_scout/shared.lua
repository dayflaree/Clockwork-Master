...
SWEP.CrouchSpread			= 0.1 --multiplier for spread when you are crouching
...
SWEP.Zoom0Cone				= 0.000001 --cone when not zoomed and zoomed twice
SWEP.Zoom1Cone				= 0.000001 --cone when zoomed once
SWEP.Zoom2Cone				= 0.000001 --cone when zoomed twice
